...
extern class Lua {
	...
	// Luau type constants (different from Lua 5.1!)
	...
	public static inline var LUA_TVECTOR:Int         = 4;  // Luau extension
	...
	public static inline var LUA_TBUFFER:Int         = 10; // Luau extension
